...
const FamilyTour = () => {
  return (
    <div className="overflow-hidden">
      ...
      <div className="bg-light-black w-full ">
        ...
        <div className="bg-dark flex-col lg:flex-row gap-x-6 p-8 h-auto flex items-center justify-center overflow-hidden w-full">
