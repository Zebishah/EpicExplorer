...
const AboveNavbar = () => {
  return (
    <div className="flex flex-col z-20">
      <nav className="flex flex-col smd:flex-row gap-y-4 justify-center lg:gap-x-44 smd:gap-x-10  py-4 px-4 bg-white backdrop-blur-md shadow-lg  w-full fixed top-0 left-0 right-0 z-10">
        <Link to={"/"}>
