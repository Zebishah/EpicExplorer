...
const EpicIntro = () => {
  return (
    <div className="flex flex-col justify-center space-x-2 items-center bg-light-black h-screen md:space-y-8 smd:space-y-28 sssm:space-y-2">
      <h1 className="text-yellows rounded-lg p-2 shadow-lg text-5xl font-joining ">
        Epic Explorer?
      </h1>
      <div className="flex flex-col md:flex-row justify-center items-center md:space-y-0 sssm:space-y-4 w-[100%] smd:w-[90%] h-auto smd:h-[70%] md:-mt-8">
        <div className="flex flex-col md:flex-row w-full h-auto md:h-[75%] mb-4 smd:mb-0 items-stretch">
          ...
          <div className="bg-fade-black w-full ml-4 lg:w-[60%] md:w-[70%] sssm:w-[90%] flex-grow p-8 shadow-lg rounded-lg flex items-start justify-start min-h-full overflow-hidden">
            <p
