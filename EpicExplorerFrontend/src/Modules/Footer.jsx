    ...
    <footer className="bg-light-black shadow-lg w-full">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-20 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <p className="font-medium text-yellows">Company</p>
            ...
            <div>
              <p className="font-medium text-yellows">Services</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75 text-white" href>
                  {" "}
                  1on1 Coaching{" "}
            ...
            <div>
              <p className="font-medium text-yellows">Helpful Links</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75 text-white" href>
                  {" "}
                  Contact{" "}
            ...
            <div>
              <p className="font-medium text-yellows">Legal</p>
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                <a className="hover:opacity-75 text-white" href>
                  {" "}
                  Privacy Policy{" "}
