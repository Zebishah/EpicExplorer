...
import image1 from "../images//r-nolan-1ZhZpP91olQ-unsplash.jpg";
...
const AllTransport = () => {
  ...
  const totalPages = Math.ceil(Transport.length / itemsPerPage);
        ...
        <div className=" mx-auto w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="w-full lg:w-[20%] p-4 bg-white rounded-lg shadow-lg">
              ...
              <div className="mt-4">
                <h4 className="font-semibold mb-2">Seater</h4>
            ...
            <div className=" flex flex-col gap-y-3 w-full lg:w-3/4">
              <div className="text-center bg-[#3654ff] py-4 rounded mb-8 text-white">
                <h1 className="text-2xl font-bold">Search for any Transport</h1>
              </div>
