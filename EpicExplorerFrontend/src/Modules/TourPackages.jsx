  ...
  return (
    <div className="flex flex-col space-y-14 flex-wrap justify-center items-center p-8">
      ...
      <div className="flex flex-row bg-light-black gap-x-10 md:mt-0 sssm:mt-72 gap-y-4 md:flex-nowrap sssm:flex-wrap">
        <div className="bg-fade-black w-full max-w-sm rounded-lg overflow-hidden mx-auto font-[sans-serif] shadow-lg shadow-yellows ">
          <img
            src={image1}
            className="w-full border-2 border-yellows border-b-0"
          />
        ...
        <div className="bg-fade-black shadow-lg shadow-yellows w-full max-w-sm rounded-lg overflow-hidden mx-auto font-[sans-serif] ">
          <img
            src={image1}
            className="w-full border-2 border-yellows border-b-0"
          />
      ...
      <button
        type="submit"
        onSubmit={BookTour}
        className="w-[20%] hover:before:bg-red rounded-xl relative h-[50px] overflow-hidden border border-yellows bg-yellows px-3 text-black shadow-lg transition-all duration-300 ease-in-out before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-light-black before:transition-all before:duration-500 hover:text-yellows hover:shadow-yellow-400 hover:before:left-0 hover:before:w-full"
      >
