...
const Reviews = () => {
  ...
  useEffect(() => {
    if (Review) {
      if (Review.getReview) {
        setReviews(Review.getReview.slice(0, 6));
      }
    }
  }, [Review]);
        ...
        {Reviews.map((review, index) => (
          ...
          >
            ...
            <p className="text-white font-radios text-center smd:text-lg text-sm">
              “Trips were amazing and i enjoyed too much in ur amazing trip i
              was so beautiful journey i really enjoyed it.Trips were amazing
              and i enjoyed too much in ur amazing trip i was so beautiful
              journey i really enjoyed it ”
            </p>
          </div>
        ))}
      </div>
